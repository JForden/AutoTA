...
Dir = '/home/jforden/Coding/AutoGrader/Scripts/output'
for file in os.scandir(Dir):
    ...
    nf = open(filename,"w")
    #print("we are currently looking at file: " + file.path)
    flag=0
    for line in f:
        words = line.split()
        for word in words:
            if word in link:
                nf.write("The Error Code you are running into is: " + word + "\n" + "If you would like more information on this error refere here: " + link[word] + "\n")
                flag=1
        if flag == 0:
            nf.write(line)
        else:
            nf.write("\n")
            flag=0
    shutil.move("/home/jforden/Coding/AutoGrader/Scripts/"+filename, "/home/jforden/Coding/AutoGrader/Scripts/output")