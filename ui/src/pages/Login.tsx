  ...
  render() {
    ...
    <div>    
        ...
        <Grid textAlign='center' style={{ height: '100vh' }} verticalAlign='middle'>
            ...
            <Message>
                Forgot your MSCSNet login? Click <a href='https://drive.google.com/file/d/1VlA4wRcizy4VpFZuMQQ0V9Fnmq-l5vcm/view?usp=sharing' target="_blank" rel="noreferrer">here</a>.
            </Message>
